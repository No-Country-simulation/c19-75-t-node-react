      ...
      <div className={styles.container}>
        <div className={styles.left}>
          <span className={styles.breadCrumbs}>
            <Link href="/">LABURAPP</Link> / <Link href="/trabajadores">TRABAJADORES</Link> /
          </span>
          <div className={styles.user}>
            <img className={styles.pp} src={user.foto ? `/${user.foto}` : '/usuario_default.png'} alt="" />
            <h1>{user.nombre + ' ' + user.apellido}</h1>
            <div className={styles.stars}>
              <FaStar className={styles.icon} />
              <span>{user?.profesionalData?.puntuacion_promedio || 'Aún sin calificaciones'}</span>
            </div>
          </div>
          ...
          <div className={styles.trabajador}>
            ...
            <div className={styles.userContainer}>
              <div className={styles.user}>
                <img src={user.foto ? `/${user.foto}` : '/usuario_default.png'} alt="" />
            ...
            <div className={styles.box}>
              <div className={styles.items}>
                ...
                <div className={styles.item}>
                  ...
                  <span className={styles.desc}>{user?.profesionalData?.categorias.join(', ')}</span>
                </div>
                <div className={styles.item}>
        ...
        <div className={styles.right}>
          <div className={styles.title}>
            ...
            <p className={styles.stars}>
              ...
              <div className={styles.star}>
                <span className={styles.promedio}>{user?.profesionalData?.puntuacion_promedio}</span>
                <FaStar className={styles.icon} />
              </div>
            </p>
          </div>
          ...
          {!isViewingOwnProfile ? (
            <Link href="" onClick={handleButtonClick} legacyBehavior>
              {
                <a
                  className={`${solicitudEnviada ? styles.sendit : styles.button}`}
                  onClick={() => {
